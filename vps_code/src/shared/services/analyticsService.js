...
const Message = require('../../features/chat/models/Message');
const Report = require('../../features/chat/models/Report');
const AnalyticsEvent = require('../../features/analytics/models/AnalyticsEvent');
const os = require('os');
...
class AnalyticsService {
    ...
    async sendToFacebookCAPI(type, distinctId, metadata = {}) {
        try {
            const MarketingConfig = require('../../features/marketing/models/MarketingConfig');
