          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildWarningItem('Re-login karke aap account reactivate kar sakte ho'),
                const SizedBox(height: 32),
                Row(
                  children: [
                    Expanded(
        ...
        children: [
          Container(
            ...
            child: ClipRRect(
              ...
              child: imageUrl != null 
                ? Image.network(imageUrl, fit: BoxFit.cover, errorBuilder: (c, e, s) => Center(child: Text(name[0].toUpperCase(), style: const TextStyle(color: Colors.orangeAccent, fontSize: 24, fontWeight: FontWeight.bold))))
                : Center(child: Text(name[0].toUpperCase(), style: const TextStyle(color: Colors.orangeAccent, fontSize: 24, fontWeight: FontWeight.bold))),
            ),
          ),
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildBenefitItem('Instant Video Call Access', showAsPremium),
              _buildBenefitItem('Priority Profile Visibility', showAsPremium),
              const SizedBox(height: 24),
              InkWell(
                onTap: () {
...
class SettingsRowItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final Color accent = iconColor ?? Colors.orangeAccent;
    return InkWell(
      onTap: onTap,
      borderRadius: BorderRadius.circular(24),
      child: Container(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    subtitle,
                    style: TextStyle(color: color.withValues(alpha: 0.4), fontSize: 11, fontWeight: FontWeight.w400),
                  ),
                ],
              ),
            ),
            Icon(Icons.arrow_forward_ios_rounded, color: color.withValues(alpha: 0.15), size: 12),
          ],
        ),
      ),
    );
